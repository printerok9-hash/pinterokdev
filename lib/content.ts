export const services = [
  {
    title: "Business printer repair",
    slug: "printer-repair",
    description:
      "On-site diagnosis and repairs for business printers, helping reduce office downtime.",
  },
  {
    title: "Business cartridge refilling",
    slug: "cartridge-refilling",
    description:
      "Compatible cartridge refilling for business printers, subject to model suitability.",
  },
  {
    title: "Office toner refilling",
    slug: "toner-refilling",
    description:
      "Keep your office running with professional toner refill and maintenance solutions.",
  },
  {
    title: "Office scanner repair",
    slug: "scanner-repair",
    description:
      "Scanner diagnosis and repairs for business document workflows.",
  },
];
export const faqs = [
  [
  ...
  [
    "Who can book a printer repair?",
    "Services are provided exclusively to business and organisational customers. We do not accept residential repair bookings. Contact us with your business postcode to check availability.",
  ],
  [
